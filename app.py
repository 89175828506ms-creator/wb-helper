if all_pick_items and hasattr(config, "EMAIL_SETTINGS"):
            ...
            html_email += "</table>"
            html_email += "<p>Наклейки прикреплены во вложении к письму.</p>"
            ...
            try:
                ...
                st.success("✉️ Готово! Письмо с наклейками и листом подбора отправлено на mebel_2026@bk.ru!")
            except Exception as e:
                st.warning(f"Заказы собраны, но произошла ошибка почты: {e}")
        else:
